export default function AdminLoginPage({ searchParams }: { searchParams?: { sent?: string } }) {
  return (
    <section className="mx-auto w-full max-w-md px-6 py-16">
      <h1 className="text-2xl font-semibold text-slate-900">Admin login</h1>
      <p className="mt-2 text-sm text-slate-600">Request a magic link to access the admin dashboard.</p>
      <form action="/api/admin/request-magic" method="post" className="mt-6 space-y-4">
        <div>
